...
TITLE = (
    ...
    ('Army Private First Class/Marine Lance Corporal','Army Private First Class/Marine Lance Corporal'),
    ('Army Private/Marine Private First Class','Army Private/Marine Private First Class'),
    ('Army Sergeant First Class/Marine Gunnery Sergeant','Army Sergeant First Class/Marine Gunnery Sergeant'),
    ('Army Sergeant First Class/Marine Gunnery Sergeant','Army Sergeant First Class/Marine Gunnery Sergeant'),
...
class FakeAppointment(models.Model):
    """
     appointments coming from patient portal
    """
...
class AntenatalAssessment(models.Model):
    ...
    nextappointmentdate = models.DateTimeField(db_column='nextAppointmentDate', blank=True,
...
class Clinic(models.Model):
    ...
    class_field = models.CharField(db_column='class',
                                   max_length=4)  # Field renamed because it was a Python reserved word.
...
class Encounter(models.Model):
    ...
    scheme_id = models.IntegerField(blank=True, null=True)
    bill_line_id = models.CharField(max_length=100, blank=True, null=True)
    referral_id = models.IntegerField(blank=True, null=True)
...
class EnrollmentsAntenatal(models.Model):
    requestcode = models.CharField(db_column='requestCode', max_length=20, blank=True,
                                   null=True)  # Field name made lowercase.
    active = models.IntegerField()
    patient_id = models.IntegerField()
...
class EstimatedBillLines(models.Model):
...
class EstimatedBills(models.Model):
    es_code = models.CharField(max_length=50)
    patient_id = models.IntegerField()
    valid_till = models.DateField()
    total_estimate = models.DecimalField(max_digits=10, decimal_places=0)
...
class FakePatient(models.Model):
    # Patient profile
    title = models.CharField(max_length=150, choices=TITLE, blank=True, null=True)
    fname = models.CharField(verbose_name="first name", max_length=150, blank=True, null=True)
    lname = models.CharField(verbose_name="last name", max_length=150, blank=True, null=True)
    ...
    occupation = models.CharField(verbose_name="occupation", max_length=20, blank=True, null=True)
    work_address = models.TextField(verbose_name="work Address", blank=True, null=True)
    ...
    lga = models.ForeignKey('Lga', models.DO_NOTHING, verbose_name='local Government Area', blank=True, null=True)
    district = models.ForeignKey(District, models.DO_NOTHING, verbose_name='district', blank=True, null=True)
    # Address of Residence
    res_state = models.ForeignKey('State', models.DO_NOTHING, verbose_name='state', related_name='res_state', blank=True, null=True)
    res_lga = models.ForeignKey('lga', models.DO_NOTHING, verbose_name='local Government Area', related_name='res_lga',blank=True, null=True)
    res_dist = models.ForeignKey(District, models.DO_NOTHING, verbose_name='district', related_name='res_district', blank=True, null=True)
    res_address = models.TextField(verbose_name='address', blank=True, null=True)
    blood_group = models.CharField(max_length=10, choices=BloodGroup, blank=True, null=True)
    geno_type = models.CharField(verbose_name='genotype', max_length=10, choices=Genotype, blank=True, null=True)
    # Next of kin details
    next_kin_fname = models.CharField(max_length=30, verbose_name='first Name', blank=True, null=True)
    next_kin_lname = models.CharField(max_length=30, verbose_name='last Name', blank=True, null=True)
    next_kin_phone = models.CharField(max_length=15, blank=True, null=True, verbose_name='Phone Number')
...
class FakeContact(models.Model):
    ...
    nation = models.ForeignKey(Countries, models.DO_NOTHING, verbose_name='country', blank=True, null=True)
    phone = models.CharField(max_length=20, blank=True, null=True)
...
class InsuranceItemsCost(models.Model):
    ...
    followupprice = models.DecimalField(db_column='followUpPrice', max_digits=12,
                                        decimal_places=2)  # Field name made lowercase.
    theatreprice = models.DecimalField(db_column='theatrePrice', max_digits=10,
                                       decimal_places=2)  # Field name made lowercase.
    anaesthesiaprice = models.DecimalField(db_column='anaesthesiaPrice', max_digits=10,
                                           decimal_places=2)  # Field name made lowercase.
    surgeonprice = models.DecimalField(db_column='surgeonPrice', max_digits=10,
                                       decimal_places=2)  # Field name made lowercase.
...
class LabResult(models.Model):
    ...
    patient_lab = models.ForeignKey('PatientLabs', models.DO_NOTHING, unique=True)
...
class LabtestsConfig(models.Model):
    ...
    testunit_symbol = models.CharField(db_column='testUnit_Symbol', max_length=30, blank=True,
                                       null=True)  # Field name made lowercase.
...
class PatientAttachment(models.Model):
    patient_id = models.IntegerField()
    category_id = models.ForeignKey(AttachmentCategory, models.DO_NOTHING, blank=True, null=True)
...
class PatientDemograph(models.Model):
    ...
    lga_id = models.IntegerField(Lga, )
...
class PatientDiagnoses(models.Model):
    ...
    diag_type = models.CharField(db_column='diag-type', max_length=2, blank=True,
                                 null=True)  # Field renamed to remove unsuitable characters.
    diagnosis = models.CharField(max_length=300, blank=True, null=True)
    field_status = models.CharField(db_column='_status', max_length=12, blank=True,
...
class PatientInRoom(models.Model):
    ...
    patientid = models.CharField(db_column='patientID', max_length=15, blank=True,
                                 null=True)  # Field name made lowercase.
...
class PatientPhysicalAssessments(models.Model):
    ...
    heent_note = models.CharField(db_column='HEENT_Note', max_length=70, blank=True,
                                  null=True)  # Field name made lowercase.
    heart = models.CharField(db_column='Heart', max_length=200)  # Field name made lowercase.
    heart_note = models.CharField(db_column='Heart_Note', max_length=70, blank=True,
                                  null=True)  # Field name made lowercase.
    lungs = models.CharField(db_column='Lungs', max_length=200)  # Field name made lowercase.
    lungs_note = models.CharField(db_column='Lungs_Note', max_length=70, blank=True,
                                  null=True)  # Field name made lowercase.
    abdomen = models.CharField(db_column='Abdomen', max_length=200)  # Field name made lowercase.
    abdomen_note = models.CharField(db_column='Abdomen_Note', max_length=70, blank=True,
                                    null=True)  # Field name made lowercase.
    extremites = models.CharField(db_column='Extremites', max_length=200)  # Field name made lowercase.
    extremites_note = models.CharField(db_column='Extremites_Note', max_length=70, blank=True,
                                       null=True)  # Field name made lowercase.
    skin = models.CharField(db_column='Skin', max_length=200)  # Field name made lowercase.
    skin_note = models.CharField(db_column='Skin_Note', max_length=70, blank=True,
                                 null=True)  # Field name made lowercase.
    neuro = models.CharField(db_column='Neuro', max_length=200)  # Field name made lowercase.
    neuro_note = models.CharField(db_column='Neuro_Note', max_length=70, blank=True,
                                  null=True)  # Field name made lowercase.
...
class PatientPreConditions(models.Model):
    patient_id = models.CharField(max_length=15)
    field_condition = models.CharField(db_column='_condition',
                                       max_length=150)  # Field renamed because it started with '_'.
...
class PhysiotherapyBooking(models.Model):
    requestcode = models.CharField(db_column='requestCode', max_length=25, blank=True,
                                   null=True)  # Field name made lowercase.
    patient_id = models.IntegerField()
...
class TestKey(models.Model):
    nr = models.IntegerField(unique=True, blank=True, null=True)
...
class Vital(models.Model):
    ...
    min_val = models.CharField(max_length=11, blank=True, null=True)
    max_val = models.CharField(max_length=11, blank=True, null=True)
